    ...
    public function run(): void
    {
        $discounts = [
            ...
            [
                ...
                'code' => 'BULK10',
                'description' => '15% discount for orders above $500',
                'type' => 'percentage',
                'value' => 15.00,
                ...
                'is_active' => true,
                'is_automatic' => true,
                'terms_conditions' => 'Automatically applied to orders above $500.',
            ],
            [
                ...
                'is_active' => true,
                'is_automatic' => false,
                'terms_conditions' => 'Valid for first-time customers only. Minimum order $100.',
            ],
            [
            ...
            [
                ...
                'code' => 'HOLIDAY25',
                'description' => '$25 off holiday special discount',
                'type' => 'fixed_amount',
                'value' => 25.00,
